...
- **Master** (claude-opus-4-7): 오케스트레이션, Live Dashboard, 회귀 루프 관리
...
- **Architect** (claude-opus-4-7): 시스템 설계; Extended Thinking (8k budget) 활성화
...
- Haiku 4.5 → Sonnet 4.6 → Opus 4.7 순으로 비용 효율적 라우팅.
