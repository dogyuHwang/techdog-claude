...
- 관련 파일: `agents/master.md` (Pre-Development Clarification 섹션)
...
- 관련 파일: `agents/master.md` (Automatic Pipeline, When to Ask the User 섹션)
...
- 관련 파일: `hooks/pre-compact.sh`, `agents/master.md` (Preemptive Context Compaction)
...
- 관련 파일: `agents/master.md` (Phase 0, Phase 4)
...
- 관련 파일: `agents/master.md` (Phase 2, Worktree Parallel Strategy)
...
- 관련 파일: `hooks/agent-tracker.sh`, `agents/master.md` (Response Format)
...
- 관련 파일: `agents/master.md` (Deep Mode 섹션), `hooks/tdc-status.sh`, `skills/tdc/SKILL.md`
...
- 관련 파일: `agents/master.md` (Deep Interview 섹션)
...
- 관련 파일: `skills/tdc-learn/SKILL.md`, `agents/master.md` (Phase 0.5: Skill Injection)
...
- 관련 파일: `hooks/rate-limit-guard.sh`, `agents/master.md` (Rate Limit Protocol)
...
- 관련 파일: `hooks/smart-read.sh`, `agents/developer.md`, `agents/debugger.md`
...
- 관련 파일: `agents/master.md`, `agents/reviewer.md`
...
- 관련 파일: `hooks/context-guard.sh`, `agents/master.md`
...
### 새 에이전트 추가
1. `agents/<name>.md` 생성 (기존 에이전트 형식 참고)
...
7. 필요시 전용 스킬 `skills/tdc-<name>.md` 생성
...
### 새 스킬 추가
1. `skills/tdc-<name>/SKILL.md` 생성 (폴더/SKILL.md 구조 필수)
...
- [ ] `~/skills/tdc/SKILL.md` 존재 확인
- [ ] `~/agents/master.md` 존재 확인
